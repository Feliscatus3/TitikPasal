...
export function EducationSection({ articles, title = 'Edukasi Hukum', subtitle, layout = 'grid', columns = 3 }: EducationSectionProps) {
        ...
        <div className="container-main">
          <header className="mb-6 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 id="education-heading" className="section-title">{title}</h2>
            </div>
            <a href="/kategori/edukasi" className="btn-ghost text-sm">
              Lihat Semua
            </a>
          </header>
            ...
            {articles.map((article) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <Link href={`/artikel/${article.slug}`} className="block" aria-label={`Baca edukasi: ${article.title}`}>
      ...
      <section className="py-8" aria-labelledby="education-heading">
        <div className="container-main">
          <header className="mb-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="p-2 rounded-lg bg-lexora-surface border border-lexora-border text-lexora-text-muted hover:text-lexora-text hover:bg-lexora-surface-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                aria-label="Edukasi selanjutnya"
              >
          ...
          {articles.length > itemsPerView && (
            <div className="flex justify-center gap-2 mt-6" role="tablist" aria-label="Navigasi edukasi">
      ...
      <div className="container-main">
        ...
        {articles.length > columns && (
          <div className="mt-6 text-center">
            <a href="/kategori/edukasi" className="btn-outline">
              Lihat Semua Edukasi Hukum
            </a>
          </div>
        )}
      </div>
